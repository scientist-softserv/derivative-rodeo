...
module Derivative
  module Zoo
    ...
    #
    # @see Derivative::Zoo::ImagePropertiesExtractor
    ...
    require 'derivative/zoo/pdf_pages_summary/extractor'

    ##
    # @api public
    #
    # @param path [String]
    # @param extractor [#call, Derivative::Zoo::PdfPagesSummary::Extractor]
    # @return [Derivative::Zoo::PdfPagesSummary]
    #
