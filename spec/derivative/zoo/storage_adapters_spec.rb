...
RSpec.describe Derivative::Zoo::StorageAdapters do
  let(:manifest) { Derivative::Zoo::Manifest::Original.new(parent_identifier: "abc", original_filename: "hello.jpg", derivatives: []) }
  ...
  describe '.for' do
    ...
    context 'when you provide an unknown adapter format' do
      ...
      it { within_block_is_expected.to raise_exception Derivative::Zoo::Exceptions::UnexpectedStorageAdapterNameError }
    end
