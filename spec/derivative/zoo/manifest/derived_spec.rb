...
RSpec.describe Derivative::Zoo::Manifest::Derived do
  let(:original) { Derivative::Zoo::Manifest::Original.new(parent_identifier: 'abc', original_filename: 'def.jpg', derivatives: []) }
  ...
  describe '#<=>' do
    ...
    let(:other_original) { Derivative::Zoo::Manifest::Original.new(parent_identifier: 'ghi', original_filename: 'def.jpg', derivatives: []) }
